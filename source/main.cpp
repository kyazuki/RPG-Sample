...
int BGM[2], ME[1], BGS[1], SE[5], BGMs = 2, MEs = 1, BGSs = 1, SEs = 5;
int Key[256];
int Dash = 0, Cheat = 0;
int FontTitle, FontMain, White, Gray, Blue;
int MenuGraph[6], MsgGraph, SelectGraph, MenuScreen, MenuScreenGAUSS;
int MapGraph[1], MapOverlayGraph[1], MapAttack[1];
