...
int attackup(int MAP, int x, int y) {
	...
	else if (wall(MAP, (CharMainX + MapX - 1) * 48 - 48 + x, (CharMainY + MapY - 1) * 48 - 48 + y) == 1 || wall(MAP, (CharMainX + MapX - 1) * 48 - 48 + x, (CharMainY + MapY - 1) * 48 - 48 + y) == 3 || wall(MAP, (CharMainX + MapX - 1) * 48 - 48 + x, (CharMainY + MapY - 1) * 48 - 48 + y) == 7 || wall(MAP, (CharMainX + MapX - 1) * 48 - 48 + x, (CharMainY + MapY - 1) * 48 - 48 + y) == 9 || wall(MAP, (CharMainX + MapX - 1) * 48 - 48 + x, (CharMainY + MapY - 1) * 48 - 48 + y) == 11) return 1;
	else if (wall(MAP, (CharMainX + MapX - 1) * 48 - 48 + x, (CharMainY + MapY - 1) * 48 - 48 + y) == 1 || wall(MAP, (CharMainX + MapX - 1) * 48 - 48 + x, (CharMainY + MapY - 1) * 48 - 48 + y) == 4 || wall(MAP, (CharMainX + MapX - 1) * 48 - 48 + x, (CharMainY + MapY - 1) * 48 - 48 + y) == 8 || wall(MAP, (CharMainX + MapX - 1) * 48 - 48 + x, (CharMainY + MapY - 1) * 48 - 48 + y) == 10 || wall(MAP, (CharMainX + MapX - 1) * 48 - 48 + x, (CharMainY + MapY - 1) * 48 - 48 + y) == 11) return 1;
	else if (wall(MAP, (CharMainX + MapX - 1) * 48 - 48 + x, (CharMainY + MapY - 1) * 48 - 48 + y) == 1 || wall(MAP, (CharMainX + MapX - 1) * 48 - 48 + x, (CharMainY + MapY - 1) * 48 - 48 + y) == 5 || wall(MAP, (CharMainX + MapX - 1) * 48 - 48 + x, (CharMainY + MapY - 1) * 48 - 48 + y) == 6 || wall(MAP, (CharMainX + MapX - 1) * 48 - 48 + x, (CharMainY + MapY - 1) * 48 - 48 + y) == 9 || wall(MAP, (CharMainX + MapX - 1) * 48 - 48 + x, (CharMainY + MapY - 1) * 48 - 48 + y) == 10) return 1;
	else return 0;
}